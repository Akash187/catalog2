...
## Getting Started
* You can *[clone](https://github.com/Akash187/Movie-Catalog-Application.git)* or *[download](https://github.com/Akash187/Movie-Catalog-Application.git)* this project via [GitHub](https://github.com) to your local machine.
...
$ python project.py
```
* After finish running project.py you can use your favorite browser to visit [this link](http://localhost:5001/)
